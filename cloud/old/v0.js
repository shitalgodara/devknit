...
var helper = require('cloud/build/message-helper.js');
...
Function to save installation id in cloud
  ...
  Procedure =>
    Simple save query on installation table
*/
...
Function to empty channels in case of app logout to stop sending notifications
  ...
  Procedure => 
    Empty channels field of installation object corresponding to install Id
*/
...
Function to restart sending notification in case of login
  ...
  Procedure =>
    Add channels field of installation object corresponding to install Id
*/
...
Function update message state comprising of likeStatus and confusedStatus ordered pair - 00(nothing), 10(liked), 01(confusing)
  ...
  Procedure =>
    ...
    * Now use new state to figure out change in like/confused count and update the corresponding objects in GroupDetails and MessageState tables
*/
...
Function to logout from the app
  ...
  Output =>
    flag: Bool // true in case of success
  Procedure =>
    Simple clear entry of channels on installation table
*/
